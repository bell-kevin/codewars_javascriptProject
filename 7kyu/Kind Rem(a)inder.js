/*
https://www.codewars.com/kata/kind-rem-a-inder/
...
the biggest remainder found is 6, and since 6 is a
*/
kira=(a,b,c)=>Math.max.apply(null,a.map((x,i)=>x%b[i]))%2==0 ? c.toLowerCase() : c.toUpperCase()
